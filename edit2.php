...
?>
        ...
        <div class="modal-content" style="width: 165%; margin-left: -35%; color: #535353;">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" > Edit Statement of Cash Flow </h5>
                </div>

                <form action="edit_connect2.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="t2" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['Business']; ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label> Year </label>
                            <input type="text" name="t2" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['year']; ?>" readonly>
                        </div>
                        <br>
                        <h5 class="modal-title" style="margin-bottom: 2%; color: #424242; font-weight: bolder;"> Operating Services</h5>
                        <div class="form-group">
                            <label> Net Income </label>
                            <input type="text" name="t2" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['t1']; ?>" readonly>
                        </div>
                        
                        <div class="form-group">
                            <label> Depreciation expense </label>
                            <input type="text" name="t2" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['t2']; ?>" required>
                        </div>
                        
                        <div class="form-group">
                            <label> Decrease in accounts receivble </label>
                            <input type="text" name="t3" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['t3']; ?>" required>
                        </div>

                        
                        <div class="form-group">
                            <label> Increase in accounts receivable</label>
                            <input type="text" name="t4" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['t4']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label> Decrease in inventory</label>
                            <input type="text" name="t5" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['t5']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label> Increase in inventory</label>
                            <input type="text" name="t6" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['t6']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label> Decrease in accounts payable</label>
                            <input type="text" name="t7" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['t7']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label> Increase in accounts payable</label>
                            <input type="text" name="t8" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['t8']; ?>"required>
                        </div>

                        <div class="form-group">
                            <label> Net Cash</label>
                            <input type="text" name="t8" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['t9']; ?>"readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="s1" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['s1']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label> Net cash use in Investing Activities </label>
                            <input type="text" name="s2" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['s2']; ?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="d1" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['d1']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label> Cash dividends </label>
                            <input type="text" name="d2" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['d2']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label> Purchase of treasury stock </label>
                            <input type="text" name="d3" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['d3']; ?>" required>
                        </div>

                        <div class="form-group">
                            <label> Net Cash used in financing Activities </label>
                            <input type="text" name="d3" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" value="<?= $data['d4']; ?>" readonly>
                        </div>
