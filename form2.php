    ...
    <button class="rounded-circle border-0" id="sidebarToggle"></button>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form method="POST" action="connection/rev.php" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel" > Income Statement </h5>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="b1" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>

                        <div class="form-group">
                            <label> Service Revenue</label>
                            <input type="text" name="b2" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>

                        <div class="form-group">
                            <label> Skills Revenue</label>
                            <input type="text" name="b3" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>

                        <div class="form-group">
                            <label> Other Revenue</label>
                            <input type="text" name="b4" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>

                        <div class="form-group">
                            <label> Interest</label>
                            <input type="text" name="b5" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="f1" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>
                        <div class="form-group">
                            <label> Supplies </label>
                            <input type="text" name="f2" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>
                        <div class="form-group">
                            <label> Utilities </label>
                            <input type="text" name="f3" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>
                        <div class="form-group">
                            <label> Insurance </label>
                            <input type="text" name="f4" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>
                        <div class="form-group">
                            <label> Rent Expense </label>
                            <input type="text" name="f5" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>
                        <div class="form-group">
                            <label> Miscellaneous </label>
                            <input type="text" name="f6" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>
                        <div class="form-group">
                            <label> Equipment </label>
                            <input type="text" name="f7" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>
                        <div class="form-group">
                            <label> Advertising </label>
                            <input type="text" name="f8" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>
                        <div class="form-group">
                            <label> Traveling </label>
                            <input type="text" name="f9" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>
                        <div class="form-group">
                            <label> Tax </label>
                            <input type="text" name="f10" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                        </div>
